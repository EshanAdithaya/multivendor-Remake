    ...
    const fetchInitialData = async () => {
      ...
      try {
        const [productsRes, categoriesRes, groupsRes, manufacturersRes] = await Promise.all([
          fetch(`${process.env.REACT_APP_API_BASE_URL}/api/products/get-all-with-filters`),
          fetch(`${process.env.REACT_APP_API_BASE_URL}/api/categories`),
          fetch(`${process.env.REACT_APP_API_BASE_URL}/api/product-groups`),
          fetch(`${process.env.REACT_APP_API_BASE_URL}/api/manufacturers`)
        ]);
    ...
    const fetchFilteredProducts = async () => {
      ...
      try {
        ...
        const endpoint = activeFilters.length === 0 
          ? `${process.env.REACT_APP_API_BASE_URL}/api/products/get-all-with-filters`
          : `${process.env.REACT_APP_API_BASE_URL}/api/products/get-all-with-filters?${new URLSearchParams(
